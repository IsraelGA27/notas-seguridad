...
┌──(israel㉿Kali-IS)-[~/Descargas/_Forensics is fun.pptm.extracted]
└─$ ls
...
└── _rels
User
┌──(israel㉿Kali-IS)-[~/Descargas/_Forensics is fun.pptm.extracted/ppt/slideMasters]
└─$ ls
...
```
## Notas adicionales
CTF: picoCTF{D1d_u_kn0w_ppts_r_z1p5}
## Referencias